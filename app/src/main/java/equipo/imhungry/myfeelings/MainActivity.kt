...
import equipo.imhungry.myfeelings.utilities.CustomBarDrawable
import equipo.imhungry.myfeelings.utilities.CustomCircleDrawable
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if(sad>verysad && sad>happy && sad>neutral && sad>verysad){
